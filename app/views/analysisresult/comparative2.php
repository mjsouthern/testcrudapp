      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview" id="resultanalysis-opt">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo URLROOT ;?>/analysisresults/comparative/analysis2/students" class="nav-link" id="stud1">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Students</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo URLROOT ;?>/analysisresults/comparative/analysis2/faculty" class="nav-link" id="faculty1">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Faculty</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo URLROOT ;?>/analysisresults/comparative/analysis2/head" class="nav-link" id="head1">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Immediate Head</p>
                </a>
              </li>
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <div class="row">
                 <h3 class="card-title"><strong>Analysis 2</strong> - By Teacher's Evaluation Results</h3>
              </div>
              <div class="row">
                <div class="col-4"> 
                ...
                <div class="col-1"> 
                   <small>Load Data</small>
                    <button type="button" class="btn btn-block btn-primary" id="loaddata2"><i class="fas fa-spinner"></i></button>
                </div> 
              </div>
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-sm-12">
                  <canvas id="comparativeanalysis2" style="height: 350px;"></canvas>
                </div>
              </div>
            </div>
            <!-- /.card-body -->
